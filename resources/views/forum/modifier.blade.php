...
@section('content')
    ...
    <div class="container">
        ...
        <form method="POST" action="/articles/modifier">
            @csrf
            @method('PUT')
            ...
            <div class="row">
                <div class="control-group col-12" hidden>
                    <input type="text" id="id" class="form-control" name="id" value="{{$article->id}}"
                           required>
                </div>
                <div class="control-group col-12">
                    <label for="nom">@lang('lang.title')</label>
                    <input type="text" id="nom" class="form-control" name="titre" required value="{{$article->titre}}">
                </div>
                <div class="control-group col-12 mt-2">
                    <label for="adresse">Article</label>
                    <textarea id="adresse" class="form-control" name="contenu"
                              rows="10" required>{{$article->contenu}}</textarea>
                </div>
                <div class="row mt-2">
